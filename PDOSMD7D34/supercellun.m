...
base2 = [-9.6226178946,16.6668631660,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4266276360];

filename='unitcellun7D34_20190123_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'unAB7D34-15-15.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'un7D34_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.unAB7D34-15-15';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 7D34 unrotated Bilayer Graphene cell with dimension 15 x15 x 1\n')
