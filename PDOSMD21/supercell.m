...
filename='unitcell21_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB21-3-3.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'21_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB21-60-60';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 21 Twisted Bilayer Graphene cell with dimension 3 x 3 x 1\n')
