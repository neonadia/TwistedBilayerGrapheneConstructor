...
filename='AB21-3-3.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB21s33-15-15.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'21s33_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB21s33-15-15';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 21s33 Twisted Bilayer Graphene cell with dimension 15 x 15 x 1\n')
...
filename4 = 'map.AB21s33-15-15';
fid4=fopen(filename4,'w');
fprintf(fid4,'%d\t %d\t %d\t %d\n',sup_x,sup_y,sup_z+1,num_of_atom);
fprintf(fid4,'Map file for 15x15x1 21s33 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
