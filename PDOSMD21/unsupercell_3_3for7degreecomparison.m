...
base1 = [19.558252,0,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-9.779126,16.937943,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.426628];

filename='unAB21-3-3.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'unAB21s33-15-15.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'21s33_unrotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.unAB21s33-15-15';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 21s33 unTwisted Bilayer Graphene cell with dimension 15 x 15 x 1\n')
...
filename4 = 'map.unAB21s33-15-15';
fid4=fopen(filename4,'w');
fprintf(fid4,'%d\t %d\t %d\t %d\n',sup_x,sup_y,sup_z+1,num_of_atom);
fprintf(fid4,'Map file for 15x15x1 21s33 unrotated  Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
