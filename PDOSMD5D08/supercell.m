...
base2 = [-13.8845027521,24.0486568092,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4266276360];

filename='unitcell5D08_20190124_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB5D08-14-14.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'5D08_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB5D08-14-14';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 5D08 Twisted Bilayer Graphene cell with dimension 14 x14 x 1\n')
