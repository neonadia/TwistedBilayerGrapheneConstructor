...
base1 = [19.2710685730,0,0];  % need to adjust according to the lattice vector in the origin file
base2 = [0,33.3784713745,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_z;
new_base3 = [0,0,6.9543900490];

filename='unitcell7_rec_clean'; %the input should be comming from shanshan's code
...
filename2 = 'AB7-4-100.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'7_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB7-4-100';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 7 Twisted Bilayer Graphene cell with dimension 4 x 100 x 1\n')
