...
base1 = [49.0968513489,0.0000000000,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-24.5484254289,42.5191139415,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4266276360];

filename='unitcell2D87_20190124_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB2D87-10-10.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'2D87_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB2D87-10-10';
fid3=fopen(filename3,'w')
fprintf(fid3,'#2D87 Twisted Bilayer Graphene cell with dimension 10 x10 x 1\n')
...
filename4 = 'map.AB2D87';
fid4=fopen(filename4,'w');
fprintf(fid4,'%d\t %d\t %d\t %d\n',sup_x,sup_y,sup_z+1,num_of_atom);
fprintf(fid4,'Map file for 10x10x1 2D87 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
