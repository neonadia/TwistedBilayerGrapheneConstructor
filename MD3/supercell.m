...
filename='unitcell3_rec_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB3-2-50.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'3.89_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB3-2-50';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 3.89 Twisted Bilayer Graphene cell with dimension 2 x 50 x 1\n')
