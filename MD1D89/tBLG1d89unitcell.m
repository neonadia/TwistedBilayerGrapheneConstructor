...
num_of_atom = 129600; %need to specify the num of atoms in the origin file
num_of_atom_new = 7352;

filename='afterrot1D89_vasp.xyz'; %the input should be comming from shanshan's code
...
n = 18; %m and n are determined by twisted angle
m = 17;
...
p1=[2*w,w,3.447195025]; %end points of unit cell on layer 1
p2= p1 + vect1;
p3= p2 + vect2;
p4= p3 + vect3;

p5=[2*w,w,0]; %end points of unit cell on layer 2
p6= p5 + vect1;
p7= p6 + vect2;
p8= p7 + vect3;
...
filename2 = 'unitcell1D89_rec.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'1.89_rotated_graphene\n')
fprintf(fid,'1.0\n')
