...
n = 13;
m = 3;
w=20; %initial posiztion, need to adjust so that
...
filename_r1='afterrot_20D31.xyz'; %the input of bilayer graphene supercell after rotation
...
p1=[10,40,c{1,4}(5200)]; %end points of unit cell on layer 1
p2= p1 + vect1;
p3= p2 + vect2;
p4= p3 + vect3;

p5=[10,40,c{1,4}(1)]; %end points of unit cell on layer 2
p6= p5 + vect1;
p7= p6 + vect2;
p8= p7 + vect3;
...
filename2 = 'unitcell20D31_20190228.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'20D31_rotated_graphene\n')
fprintf(fid,'1.0\n')
