...
base1 = [74.7994918823,0,0];  % need to adjust according to the lattice vector in the origin file
base2 = [0,129.5565185547,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_z;
new_base3 = [0,0,6.9543900490];

filename='unitcell1D89_rec_fine.vasp'; %the input should be comming from shanshan's code
...
filename3 = 'data.AB1D89-1-40';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 1.89 Twisted Bilayer Graphene cell with dimension 1 x 40 x 2\n')
