...
base1 = [10.7407436371,0.0000000000,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-5.3703718185,9.3017568453,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4244065285];

filename='unitcell13_fine'; %the input should be comming from shanshan's code
...
filename2 = 'AB13-15-15.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'13_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB13-36-36';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 13 Twisted Bilayer Graphene cell with dimension 36 x36 x 1\n')
...
filename4 = 'map.AB13_36_36';
fid4=fopen(filename4,'w');
fprintf(fid4,'%d\t %d\t %d\t %d\n',sup_x,sup_y,sup_z+1,num_of_atom);
fprintf(fid4,'Map file for 36x36x1 13 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
