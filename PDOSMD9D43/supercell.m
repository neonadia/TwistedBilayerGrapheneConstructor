...
base1 = [14.9885368347,0.0000000000,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-7.4942676690,12.9804518406,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4266276360];

filename='unitcell9D43_20190122_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB9D43-10-10.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'9D43_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB9D43-10-10';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 9D43 Twisted Bilayer Graphene cell with dimension 10 x10 x 1\n')
