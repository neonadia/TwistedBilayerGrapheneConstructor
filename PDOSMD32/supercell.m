...
base1 = [8.8844398405645588,0.0000000000,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-4.4422209448285823,7.6941500088189798,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4260104996574903];

filename='unitcell32_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB32-16-16.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'32_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB32-16-16';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 32 Twisted Bilayer Graphene cell with dimension 16 x1 6 x 1\n')
...
fprintf(fid4,'Map file for 16x16x1 32 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
