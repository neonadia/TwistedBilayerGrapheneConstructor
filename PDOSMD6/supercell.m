...
base1 = [23.5060939789,0.0000000000,0];  % need to adjust according to the lattice vector in the origin file
base2 = [-11.7530469894,20.3568745295,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_y;
new_base3 = [0,0,6.4266276360];

filename='unitcell6_20181201_fine.vasp'; %the input should be comming from shanshan's code
...
filename2 = 'AB6-6-6.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'6_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB6-6-6';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 6 Twisted Bilayer Graphene cell with dimension 6 x 6 x 1\n')
...
fprintf(fid4,'Map file for 6x6x1 6 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
