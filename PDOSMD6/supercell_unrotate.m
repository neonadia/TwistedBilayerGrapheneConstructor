...
filename3 = 'data.unAB21-20-20';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 21 unTwisted Bilayer Graphene cell with dimension 20 x 20 x 1\n')
...
filename4 = 'map.unAB21';
fid4=fopen(filename4,'w');
fprintf(fid4,'%d\t %d\t %d\t %d\n',sup_x,sup_y,sup_z+1,num_of_atom);
fprintf(fid4,'Map file for 20x20x1 21 Bilayer Graphene cell.\n');
mmm=1;
k_m = 1;
