...
num_of_atom_new = 1352;

filename='afterrot4_vasp.xyz'; %the input should be comming from shanshan's code
...
n = 8; %m and n are determined by twisted angle
m = 7;
...
filename2 = 'unitcell4_rec.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'4_rotated_graphene\n')
fprintf(fid,'1.0\n')
