...
filename='unitcell4_rec_fine.vasp'; %the input should be comming from shanshan's code
...
filename3 = 'data.AB4-3-60';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 4.40 Twisted Bilayer Graphene cell with dimension 3 x 60 x 1\n')
