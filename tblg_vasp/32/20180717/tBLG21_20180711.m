...
filename_r1='afterrot_32_20180717.xyz'; %the input of bilayer graphene supercell after rotation
...
filename_r2='CONTCAR_32_unrotated.vasp'; %the input of graphene unitcell
...
p1=[w,w,c{1,4}(5200)]; %end points of unit cell on layer 1
p2= p1 + vect1;
p3= p2 + vect2;
p4= p3 + vect3;
...
filename2 = 'unitcell32_20180717.vasp';
