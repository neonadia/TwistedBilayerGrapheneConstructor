...
num_of_atom = 7600; %need to specify the num of atoms in the origin file
num_of_atom_new = 76;

filename_r1='afterrot_13_20180726.xyz'; %the input of bilayer graphene supercell after rotation
...
filename_r2='CONTCAR_13_degree.vasp'; %the input of graphene unitcell
...
p1=[w,w,c{1,4}(7600)]; %end points of unit cell on layer 1
p2= p1 + vect1;
p3= p2 + vect2;
p4= p3 + vect3;
...
filename2 = 'unitcell13_20180726.vasp';
