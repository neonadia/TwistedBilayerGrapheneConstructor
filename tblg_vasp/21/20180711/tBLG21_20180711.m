...
filename_r1='afterrot_20180711.xyz'; %the input of bilayer graphene supercell after rotation
...
filename_r2='CONTCAR_21_unrotated_bulk.vasp'; %the input of graphene unitcell
...
vector = textscan(fid_r2,'%.f %.f %.f',3);
...
filename2 = 'unitcell21_20180711.vasp';
