...
filename='afterrot17_vasp.xyz'; %the input should be comming from shanshan's code
...
n = 5; %m and n are determined by twisted angle
m = 1;
...
filename2 = 'unitcell17_rec.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'17_rotated_graphene\n')
fprintf(fid,'1.0\n')
