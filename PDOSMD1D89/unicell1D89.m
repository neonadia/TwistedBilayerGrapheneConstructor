...
filename_r1='afterrot_1D89.xyz'; %the input of bilayer graphene supercell after rotation
...
p1=[w,w,c{1,4}(83200)]; %end points of unit cell on layer 1
p2= p1 + vect1;
p3= p2 + vect2;
p4= p3 + vect3;
...
filename2 = 'unitcell1D89_20190124.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'1D89_rotated_graphene\n')
fprintf(fid,'1.0\n')
